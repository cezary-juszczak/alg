...
| Sortowanie szybkie              | $\Theta(n \lg n)$ (oczekiwana dla wersji randomizowanej) | $\Theta(n^2)$ | $\Theta(\lg n)$ (głębokość rekursji) | $\Theta(n)$ (głębokość rekursji - ale można zmniejejszyć do $\Theta(\lg n)$ |
